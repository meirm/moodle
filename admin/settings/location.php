...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    // New settings page
    $settings = new admin_settingpage('iplookup',
        get_string('iplookup', 'admin'));
    ...
    $temp->add(new
	admin_setting_configselect('iplookup/mapprovider',
	    get_string('mapprovider', 'admin'),
	    get_string('mapprovider_desc','admin'), 'worldmap',
	    $mapproviders));
            
    $temp->add(new admin_setting_configfile('iplookup/geoip2file', new lang_string('geoipfile', 'admin'),
        new lang_string('configgeoipfile', 'admin', $CFG->dataroot.'/geoip/'), $CFG->dataroot.'/geoip/GeoLite2-City.mmdb'));
    $temp->add(new admin_setting_configtext('iplookup/googlemapkey3', new lang_string('googlemapkey3', 'admin'), new lang_string('googlemapkey3_help', 'admin'), '', PARAM_RAW, 60));
